...
var $author$project$Main$ChoiceKey = function (a) {
	return {$: 'ChoiceKey', a: a};
};
...
var $author$project$Main$keyDecoder = function () {
	var toKey = function (string) {
		switch (string) {
			case 'ArrowLeft':
				return $author$project$Main$ChoiceKey($author$project$Main$Left);
			case 'ArrowRight':
				return $author$project$Main$ChoiceKey($author$project$Main$Right);
			case 'r':
				return $author$project$Main$R;
			default:
				return $author$project$Main$UnknownKey;
		}
	};
	return A2(
